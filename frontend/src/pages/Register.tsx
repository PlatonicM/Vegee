                ...
                <div className="relative bg-vegge-dark text-white p-14 lg:p-16 flex flex-col justify-between overflow-hidden md:w-1/2">
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-5xl font-extrabold leading-[1.1] mb-8 tracking-tighter">
                            Join the healthy<br />revolution
                        </h2>
                        <p className="text-white/80 text-xl font-medium max-w-sm leading-relaxed">
                            Create an account to start your journey towards a healthier lifestyle with farm-fresh organic produce exclusive discounts, and a healthier lifestyle
                        </p>
                    </div>

                    <div className="relative z-10 space-y-6 mt-12">
                        {[
                            { icon: Leaf, text: "Direct from organic certified farms" },
                            { icon: ShieldCheck, text: "Verified quality & safety standards" },
                    ...
                    <div className="w-full max-w-md">
                        <div className="mb-12">
                            <h3 className="text-4xl font-black text-gray-900 mb-4 tracking-tight">
                                Create Account<span className="text-vegge-DEFAULT"></span>
                            </h3>
                            <p className="text-gray-500 font-medium text-lg leading-relaxed">
                                Join our vegee community  for direct farm fresh vegetable benefits 
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleRegister} className="space-y-8">
                            <div className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group">
                                        <User className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-vegge-DEFAULT transition" size={20} />
                                        <input
                                            type="text"
                                            required
                                            value={name}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            placeholder="vegge134@gmail.com"
                                            className="w-full pl-16 pr-6 py-5 bg-gray-50 border border-transparent rounded-[2rem] focus:ring-4 focus:ring-vegge-DEFAULT/10 focus:border-vegge-DEFAULT focus:bg-white outline-none transition-all font-bold text-gray-900"
                                        />
                                    </div>
                                </div>
                            ...
                            >
                                {loading ? "Creating Identity..." : "Sign In"}
                        ...
                        <div className="mt-12 text-center pt-10 border-t border-gray-50">
                            <span className="text-gray-400 font-bold">Already Member?</span>
                            <Link to="/login" className="text-vegge-dark font-black ml-2 hover:text-vegge-DEFAULT transition hover:underline">
                                Sign In
                            </Link>
                        </div>
                    </div>
